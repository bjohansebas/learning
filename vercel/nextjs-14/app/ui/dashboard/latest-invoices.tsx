              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="min-w-0">
                    <p className="truncate font-semibold text-sm md:text-base">{invoice.name}</p>
                    <p className="hidden text-gray-500 text-sm sm:block">{invoice.email}</p>
                  </div>
                </div>
                <p className={`${lusitana.className} truncate font-medium text-sm md:text-base`}>{invoice.amount}</p>
              </div>
            )
          })}
        </div>
