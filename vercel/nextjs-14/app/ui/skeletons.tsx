...
export default function DashboardSkeleton() {
  return (
    <>
      ...
      <div className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-8 md:grid-cols-4">
...
export function TableRowSkeleton() {
  return (
    <tr className="w-full border-gray-100 border-b [&:first-child>td:first-child]:rounded-tl-lg [&:first-child>td:last-child]:rounded-tr-lg [&:last-child>td:last-child]:rounded-br-lg [&:last-child>td:first-child]:rounded-bl-lg last-of-type:border-none">
          ...
          <table className="hidden min-w-full text-gray-900 md:table">
            <thead className="rounded-lg text-left font-normal text-sm">
              <tr>
                ...
                <th scope="col" className="relative pt-2 pr-6 pb-4 pl-3 sm:pr-6">
