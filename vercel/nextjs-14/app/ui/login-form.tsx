    ...
    <form action={dispatch} className="space-y-3">
      <div className="flex-1 rounded-lg bg-gray-50 px-6 pt-8 pb-4">
        ...
        <div className="w-full">
          <div>
            <label className="mt-5 mb-3 block font-medium text-gray-900 text-xs" htmlFor="email">
              Email
            </label>
          ...
          <div className="mt-4">
            <label className="mt-5 mb-3 block font-medium text-gray-900 text-xs" htmlFor="password">
              Password
            </label>
            <div className="relative">
              <input
